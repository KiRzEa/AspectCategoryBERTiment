...
def mapping_category(domain, category):
    if domain =="Restaurant":
        return restaurant_dict[category].lower().strip()
    elif domain == "Hotel":
        return hotel_dict[category].lower().strip()
    
    elif domain == "Mother":
        return model_dict[category].lower().strip()
    
    elif domain == "Technology":
        return technology_dict[category].lower().strip()
    
    elif domain == "Education":
        return education_dict[category].lower().strip()
    
    elif domain == "Beauty":
        return beauty_dict[category].lower().strip()
    
    elif domain == "Phone":
        return phone_dict[category].lower().strip()
